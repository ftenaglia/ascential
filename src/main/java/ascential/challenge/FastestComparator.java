...
public final class FastestComparator {
  ...
  /**
   * Get an int and CustomNumberEntity values as input and compare them as a int numbers Time needed
   * to make the comparison will be between 5 and 10 seconds
   *
   * @param firstValue
   * @param secondValue
   * @return 0 if both values are equal, > 0 if first value is greater < 0 if second value is
   *     greater
   */
